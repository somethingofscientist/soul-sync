    ...
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                <div className={styles.heading}> 3. Eligibility</div>
                <div className={styles.sub_points}>
                    <ol>
                        <li>
                            You must be of marriageable age as per the applicable personal/general law.
                        </li>
                        <li>
                            By using the app, you represent and warrant that you are of legal age to form a binding contract.
                        </li>
                        <li>
                            You do not hold more than 1 account on our platform.
                        </li>
                        <li>
                            You have not previously been removed from our platform by us or our affiliates, unless you have our express written permission to create a new account.
                        </li>
                        <li>
                            You are not prohibited by law from using our services.
                        </li>
                        <li>
                            You have not committed, been convicted of, or been accused of a sex crime, or any crime involving violence; or a threat of violence, unless you have been acquitted, received leniency for a non-violent crime and we have determined that you are not likely to pose a threat to other Users of our Services.
                        </li>
                        <li>
                            If at any time you cease to meet these requirements, all authorization to access our platform shall be automatically revoked, and you must immediately delete your account.
                        </li>
                    </ol>
                </div>

                <div className={styles.heading}>4. User Registration </div>
                <div className={styles.text}>
                    To access certain features of the app, you may be required to provide personal information during the registration/onboarding process. You agree that all information provided is accurate, current, and complete. <br /> <br />
                    <b>You agree to:</b> <br />
                </div>
                <div className={styles.sub_points}>
                    <li>
                ...
                <div className={styles.heading}> 5. User Consent</div>
                <div className={styles.sub_heading}> Consent for Data Processing:</div>
                <div className={styles.sub_points}>
                    <ol>
                        <li>
                            All personal data provided by Users on our Platform shall be used for purposes consented by the User and for legitimate purposes.All such User data shall be protected and processed at every stage as per the Digital Personal Data Protection Act, 2023(the “Act”).
                        </li>
                        <li>
                            At every stage, including but not limited to the onboarding process, User consent qua usage of their personal data shall be obtained whereby the User may choose to provide his / her consent in English or in any other regional language.Each time we seek User consent, it shall be preceded by a notice that clearly conveys the specific purpose for which such data is to be processed, the manner in which a User can withdraw their consent and grievance redressal mechanism available to the user, if needed.
                        </li>
                        <li>
                            During the onboarding process, you consent for the collection and processing of your personal data, as outlined in our Privacy Policy.
                        </li>
                        <li>
                            Withdrawal of User Consent: Every User will be provided with the option to withdraw his / her consent at any time with ease.
                        </li>
                    </ol>
                </div>
                ...
                <div className={styles.heading}>6. User Input and Data</div>

                <div className={styles.sub_heading}>  a.User Preferences:</div>

                <div className={styles.sub_points_again}>
                    <ul>
                        <li>
                            In order to use the Platform, a User may sign in using their phone number.By doing so, you authorize us access to your phone number which will be used securely.
                        </li>
                        <li>
                            The Platform collects and processes User preferences based on 15 input categories, including lifestyle, family, employment, and education details, to provide curated matchmaking suggestions.
                        </li>

                        <li>
                            The Company collects information / data including e - mail id, address, first name, last name, telephone / mobile number, date of birth, age, gender, ethnic / cultural background, appearance, religion, occupation, preferences, life style information, general geographical location(“User Data”) from Users in order to enable them to create their profiles on the Platform.Apart from this, certain other health related information, including physical and mental disabilities are also collected.The User Data so collected is entered in a program especially devised for matching profiles and to provide matches for Users based on their pre - selected partner preferences criteria.User Data is displayed only after taking prior consent of Users.The Company enables Users with the option to make payments and in -app purchases by way of credit card and, thus, User Data obtained therefrom may be used by the Company purely for payment purposes.The Company assures that such User Data will not be stored or used for any other purpose / s.The Company will not be able to provide access to the Platform and / or create profiles of Users if the requisite User Data is not provided by the Users.User hereby consents to usage of their User Data to be displayed to other Users on the Platform.
                        </li>

                        <li>
                            The Platform also performs user verification by using existing User Data such as name, phone number, etc.to conduct legal/criminal background check of the User through an automated API with a third-party database. To conduct a more thorough check for the aforesaid purpose, the Platform may require Users to provide their Aadhar card details and, in collecting such information, the Company assures the storage of such information in encrypted form for maximum protection of User Data.
                        </li>
                ...
                <div className={styles.sub_heading}>
                    <b>b.Images and Videos:</b>
                </div> <div className={styles.text1}> Users can upload images and videos to their profiles.By doing so, you grant the Platform the right to use and display this content for matchmaking purposes.</div>





                <div className={styles.heading}>7. User Conduct</div>
                ...
                <div className={styles.heading}>8. Push Notifications, Location - based features</div>
                ...
                <div className={styles.heading}>9. Grievance Redressal</div>
                    ...
                    <ol>
                        <li>
                            ...
                            <div className={styles.sub_points_again}>
                                <ul>
                                    <li>
                                        any negligent acts, omission or wilful misconduct by you;
                                    </li>
                                    <li>
                                        your access to and use of the Platform;
                                    </li>
                                    <li>
                                        the uploading or submission of content on the Platform by you;
                                    </li>
                                    <li>
                        ...
                        <li>
                            ...
                            <div className={styles.sub_points_again}>
                                <ul>
                                    <li>
                                        the user’s access to or use of or inability to access or use the Platform,
                                    </li>
                                    <li>
                                        the conduct or content of any Users or third parties on the Platform in connection with the services provided by us; or
                                    </li>
                                    <li>
                                        unauthorized access, use, or alteration of your content, even if the Company has been advised of the possibility of such damages.
                                    </li>
                                </ul>
                            </div>
                            <br />
                ...
                <div className={styles.heading}>12. Acceptance of Terms</div>
                <div className={styles.text1}>
                ...
                <div className={styles.heading}>13. Entire Agreement</div>
                <div className={styles.sub_points}>
                    <ol>
                        <li>
                            <h2>Interpretation and Severability:</h2>
                            <div className={styles.sub_points_again}>
                                <ul>
                                    <li>
                        ...
                        <li>
                            <h2>Transferability of User Account:</h2>
                        ...
                        <li>
                            <h2>Amendment: </h2> This Agreement may be modified or amended by the Company in its sole discretion.If a User disagrees with such amendment, user’s sole remedy is to terminate their account on the Platform.Unless expressly agreed by the Parties in writing, any amendment of this Agreement is effective from the date of such amendment and shall stay in force thereafter.
                        </li>

                        <li>
                            <h2>Waiver:</h2> The waiver of any breach of this Agreement is effective only if it is in writing by an authorized representative of the Company waiving such breach and no such waiver will be construed as a waiver of any subsequent breach.
                        </li>
                        <li>
                            <h2>Liability:</h2> This Agreement does not provide any basis for either Party or any other person to recover damages of any type other than those set forth herein and subject to all limitations set forth therein in the above clause titled ‘Indemnity and Liability’.
                        </li>
                        <li>
                            <h2>Enforcement:</h2> The terms of this Agreement may only be enforced by the Parties on behalf of themselves and their respective affiliates, if any, in accordance with the dispute resolution provisions set forth in this Agreement.This restriction on enforcement has no effect except on an individual Party’s ability to enforce their rights under the Data Protection Laws.
                        </li>
                        <li>
                            <h2>Termination:</h2> Unless terminated earlier pursuant to this Agreement or any other applicable provision of the Company’s policies or any applicable Data Protection Laws, this Agreement shall terminate upon the completion of processing or termination of the Agreement, whichever is later.Following termination of this Agreement, the Company will return, delete, or de - identify User data pursuant to the terms of this Agreement unless the Company is required to maintain User data pursuant to applicable law.If the Company is required to retain User data following termination of this Agreement, the Company will continue to comply with its obligations relating to the processing of User data under this Agreement and will promptly return or delete any such User data after retention is no longer legally required.
                        </li>
                        <li>
                            <h2>Governing Law and Jurisdiction:</h2> This Agreement is governed by the laws stipulated in this Agreement, except to the extent otherwise required by the Data Protection Laws, in which case the laws of the jurisdiction prescribed by the Data Protection Laws apply.No provision of this Agreement shall be deemed to limit any person’s rights or obligations under any applicable Data Protection Laws.
                        </li>
                    </ol>
                </div>

                <div className={styles.heading}>14. Termination of User Account on the Platform</div>
                <div className={styles.text1}>
                ...
                <div className={styles.heading}>15. Changes to Terms and Conditions</div>
                <div className={styles.text1}>
                ...
                <div className={styles.heading}> 16. Governing Law & Dispute Resolution</div>
                <div className={styles.text1}>
                ...
                <div className={styles.text1}>
                    ...
                    SoulSync is a trademark of SoulSync Services Private Limited. <br /> <br />
